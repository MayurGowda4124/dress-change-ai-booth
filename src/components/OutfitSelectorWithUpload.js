...
const OutfitSelectorWithUpload = ({ onOutfitSelect, selectedOutfit }) => {
  ...
  const handleImageUpload = (file) => {
    const uploadedOutfit = {
      id: 'uploaded',
      name: 'Your Uploaded Outfit',
      image: URL.createObjectURL(file),
      file: file
    };
    setSelectedOutfitId('uploaded');
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Select from existing outfits or upload your own</p>
      </div>
...
export default OutfitSelectorWithUpload; 